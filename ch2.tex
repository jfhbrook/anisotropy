...
\marginpar{This needs to be formalized. I have python code somewhere, which may
also be a good thing to take snippets of.}
...
an isotropic case with respect to some \(x' = a_x x\) and \(y' = a_y y\).
