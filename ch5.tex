...
\caption{Slices of theoretical predictions by angle. Black points connected by dashed lines represent numerical results, while solid blue lines represent analytical theory. It can be seen that the analytical theory predicts measured conductivity to be a stronger function of angle than the numerical data.}
\label{fig:by_angle}
\end{figure}
...
numerical model over-predicts the thermal conductivity for
isotropic materials by roughly \(10\%\), and generally predicts smoother
...
primarily responsible for the smoothing of \(k_{\textrm{eff}}(\theta)\) at more extreme
...
% Discuss how to sort this out in a future study.
...
First, it may be seen that there is a significant amount of variation between
measurements using the needle probe method, even accounting for obviously failed measurements.
...
this variation, it is difficult to see which of the two models is more appropriate.
