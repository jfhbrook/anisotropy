...
In this document, studies concentrateCar on the heating curve. In fact, the
...
\label{fig:angle}
\caption{A diagram illustrating the meaning of \(\theta\) in models and
measurements. In all these cases, \(\theta\) is measured from the horizontal
plane, which is also the plane of isotropy.}
\end{figure}


\section{Outline}
\marginpar{What should I call this section anyway?}

\marginpar{This is terrible. I really need to rewrite it.}
