...
Data extracted from the Campbell data logger and converted from binary is in
csv format.

In practice, really easy to screw up. Write about future streamlining of process.
